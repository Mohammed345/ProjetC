...
void afficheemp(){
			...
			while(fread(&e,sizeof(e),1,fp)==1) 
            {
			    ...
			    printf("\nnom:%10s  prenom:%10s  CIN:%8s  EMAIL:%25s   DN:%d/%d/%d   tele:%10s    SALAIRE:%.2f    PROFESSION:%10s",e.nom,e.prenom,e.CIN,e.email,e.d.jj,e.d.mm,e.d.aaaa,e.tele,e.salaire,e.proffession); /// print the name, age and basic salary
            }
            getch();
}
void modifier() {
...
int main() {
  ...
  system("color F1");
   printf("\t\t\t\t\t\t\t###########################################################################");
    printf("\n\t\t\t\t\t\t\t############                                                   ############");
    printf("\n\t\t\t\t\t\t\t#########      application qui gere les personnels de ENSAH       #########");
    printf("\n\t\t\t\t\t\t\t############                                                   ############");
    printf("\n\t\t\t\t\t\t\t###########################################################################");
    printf("\n\t\t\t\t\t\t\t---------------------------------------------------------------------------\n");
    printf("\n\t\t\t\t\t\t\t----------------------------------------------------------------------------\n");
